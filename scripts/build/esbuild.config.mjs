...
const patchRendererUnsafeUnref = createRequire(import.meta.url)("./patchRendererUnsafeUnref.js");
const { createBundleSizeGuard } = createRequire(import.meta.url)("./bundleSizeGuard.js");
