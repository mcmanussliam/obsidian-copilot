...
#
# Usage:
#   COPILOT_TEST_VAULT_PATH=/path/to/vault scripts/vault/seed-skills-scenarios.sh
#   COPILOT_TEST_VAULT_PATH=/path/to/vault scripts/vault/seed-skills-scenarios.sh --clean
#   COPILOT_TEST_VAULT_PATH=/path/to/vault scripts/vault/seed-skills-scenarios.sh --list
#
# Flags:
