...
import type { ModelManagementApi, ProviderType } from "@/model-management";
import { getSettings, setSettings, type CopilotSettings } from "@/settings/model";
import { Platform } from "obsidian";

import { CURRENT_SETTINGS_VERSION, runSettingsMigrations } from "@/settings/migrations";
...
jest.mock("@/miyo/miyo-status-store", () => ({ isMiyoAvailableForCapability: jest.fn() }));

jest.mock("@/services/keychain-service", () => ({
