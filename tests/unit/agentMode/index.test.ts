...
import type { BuiltinSkillRuntime } from "@/agentMode/skills/SkillManager";
import { createAgentSessionManager } from "@/agentMode/index";
import { reconcileBuiltinSkills } from "@/agentMode/skills/builtin/reconcileBuiltinSkills";
...
jest.mock("@/agentMode/session/AgentModelPreloader", () => ({ AgentModelPreloader: jest.fn() }));
jest.mock("@/agentMode/session/AgentSessionIndex", () => ({ AgentSessionIndex: jest.fn() }));
jest.mock("@/agentMode/session/nodeFileStorage", () => ({ createNodeFileStorage: jest.fn() }));
jest.mock("@/agentMode/session/AgentSessionManager", () => ({
...
jest.mock("@/agentMode/skills/builtin/reconcileBuiltinSkills", () => ({
  ...jest.requireActual("@/agentMode/skills/builtin/reconcileBuiltinSkills"),
...
jest.mock("@/agentMode/backends/opencode/opencodeProbePartition", () => ({}));
jest.mock("@/agentMode/backends/opencode/opencodeModelResolve", () => ({}));
