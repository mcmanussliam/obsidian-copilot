...
} from "@/agentMode/session/AgentSession";
...
import type { ApplySelectionContext } from "@/agentMode/session/descriptor";
import type { FanoutRunInput } from "@/agentMode/session/fanout/FanoutOrchestrator";
import { FANOUT_READONLY_PREAMBLE, type FanoutTurn } from "@/agentMode/session/fanout/fanoutTypes";
import type {
  AgentToolCallOutput,
  BackendDescriptor,
  BackendProcess,
