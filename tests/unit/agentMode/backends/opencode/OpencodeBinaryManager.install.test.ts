import * as opencodeVersion from "@/agentMode/backends/opencode/ui/opencodeVersion";
import { OpencodeBinaryManager } from "@/agentMode/backends/opencode/OpencodeBinaryManager";
...
jest.mock("@/agentMode/backends/opencode/platformResolver", () => ({
