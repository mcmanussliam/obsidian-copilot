import { verifyOpencodeBinary } from "@/agentMode/backends/opencode/OpencodeBinaryManager";
...
} from "@/agentMode/backends/opencode/OpencodeBackend";
import {
...
jest.mock("@/agentMode/backends/opencode/OpencodeBinaryManager", () => ({
  ...jest.requireActual("@/agentMode/backends/opencode/OpencodeBinaryManager"),
