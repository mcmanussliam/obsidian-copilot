import { signOutFromClaude } from "@/agentMode/backends/claude/claudeAuth";
jest.mock("@/agentMode/backends/claude/claudeAuth", () => ({ signOutFromClaude: jest.fn() }));
...
import { resolveClaudeBinary } from "@/agentMode/backends/claude/claudeBinaryResolver";
import { claudeCompatibilityStore } from "@/agentMode/backends/claude/claudeCompatibilityStore";
import {
  ...
  updateClaudeFields,
} from "@/agentMode/backends/claude/descriptor";

jest.mock("@/agentMode/backends/claude/claudeBinaryResolver", () => ({
  claudeBinarySearchDirs: jest.fn(() => []),
  resolveClaudeBinary: jest.fn(),
}));

jest.mock("@/agentMode/backends/claude/claudeCompatibilityStore", () => ({
