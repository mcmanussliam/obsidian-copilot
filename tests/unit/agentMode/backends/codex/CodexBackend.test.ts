...
import { CodexBackend } from "@/agentMode/backends/codex/CodexBackend";
import { resolveSupportedCodexAcpEntry } from "@/agentMode/backends/codex/codexVersion";
import * as codexVersion from "@/agentMode/backends/codex/codexVersion";
...
jest.mock("@/agentMode/backends/codex/codexVersion", () => {
  const actual = jest.requireActual("@/agentMode/backends/codex/codexVersion");
  return {
    ...actual,
    __esModule: true,
