import { codexAuth } from "@/agentMode/backends/codex/codexAuth";
import type CopilotPlugin from "@/main";
import { getSettings, setSettings, type CopilotSettings } from "@/settings/model";
import { detectBinary } from "@/utils/detectBinary";
import { resolveCodexAcpBinary } from "@/agentMode/backends/codex/codexBinaryResolver";
import { CODEX_PINNED_VERSION } from "@/agentMode/backends/codex/codexArchive";
import {
  CodexBackendDescriptor,
  detectCodexAcpPath,
  getCodexBinaryManager,
} from "@/agentMode/backends/codex/descriptor";
import {
...
jest.mock("@/agentMode/backends/codex/codexBinaryResolver", () => ({
  codexAcpSearchDirs: jest.fn(),
  resolveCodexAcpBinary: jest.fn(),
}));
jest.mock("@/agentMode/backends/codex/codexVersion", () => ({
  ...jest.requireActual("@/agentMode/backends/codex/codexVersion"),
