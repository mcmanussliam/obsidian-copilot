...
import { installCodexArchive, CODEX_PINNED_VERSION } from "@/agentMode/backends/codex/codexArchive";
...
jest.mock("@/agentMode/backends/codex/codexArchive", () => ({
  ...jest.requireActual<object>("@/agentMode/backends/codex/codexArchive"),
