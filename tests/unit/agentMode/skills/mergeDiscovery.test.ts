import type { ProjectSkillCandidate } from "@/agentMode/skills/discoverProjectSkills";
import { formatSkillDisplayName, mergeDiscovery } from "@/agentMode/skills/mergeDiscovery";
