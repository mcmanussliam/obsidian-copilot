...
import type { SkillLoadIssue } from "@/agentMode/skills/ui/SkillLoadIssues";
import { SkillsSettings } from "@/agentMode/skills/ui/SkillsSettings";
...
jest.mock("@/agentMode/skills/ui/SkillLoadIssues", () => {
  const actual = jest.requireActual("@/agentMode/skills/ui/SkillLoadIssues");
  return {
    ...actual,
