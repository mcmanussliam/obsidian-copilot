import { ActionBlockStreamer } from "@/llm-providers/chain-runner/utils/action-block-streamer";
import { ToolManager } from "@/tools/tool-manager";
import { ToolResultFormatter } from "@/tools/tool-result-formatter";

// Mock the ToolManager and ToolResultFormatter
jest.mock("@/tools/tool-manager");
jest.mock("@/tools/tool-result-formatter");
