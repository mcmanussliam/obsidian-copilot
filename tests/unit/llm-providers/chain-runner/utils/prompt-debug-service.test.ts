import {
  generatePromptDebugReportForAgent,
  resolveBasePrompt,
} from "@/llm-providers/chain-runner/utils/prompt-debug-service";
import type ChainManager from "@/llm-providers/chain-manager";
import { ModelAdapter, PromptSection } from "@/llm-providers/chain-runner/utils/model-adapter";
import { mockTFile } from "@tests/helpers/mock-obsidian";
import { PromptDebugReport } from "@/llm-providers/chain-runner/utils/tool-prompt-debugger";
