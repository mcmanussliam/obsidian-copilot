import { buildPromptDebugReport } from "@/llm-providers/chain-runner/utils/tool-prompt-debugger";
import { PromptSection } from "@/llm-providers/chain-runner/utils/model-adapter";
