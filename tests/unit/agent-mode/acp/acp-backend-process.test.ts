...
import type { BackendDescriptor, PermissionOption } from "@/agent-mode/session/types";
import { AcpBackendProcess } from "@/agent-mode/acp/acp-backend-process";
import type { AcpBackend } from "@/agent-mode/acp/types";
import type { VaultClient } from "@/agent-mode/acp/vault-client";
...
jest.mock("@/agent-mode/acp/acp-process-manager", () => ({
