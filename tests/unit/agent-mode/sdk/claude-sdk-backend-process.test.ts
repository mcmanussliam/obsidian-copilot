...
import type { BackendDescriptor, SessionEvent } from "@/agent-mode/session/types";
...
} from "@/agent-mode/sdk/claude-sdk-backend-process";
import { getCachedSdkCatalog } from "@/agent-mode/sdk/effort-option";
import { AuthRequiredError } from "@/agent-mode/session/errors";
