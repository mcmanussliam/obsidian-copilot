 ...
 *
 * The Agent Mode barrel (`@/agent-mode`) and the settings module are mocked so
...
import type { ModelManagementApi, Provider, ProviderOrigin } from "@/model-management";
import type CopilotPlugin from "@/main";
import type { AgentSessionManager, BackendDescriptor } from "@/agent-mode";
...
import {
  buildManagedOpencodeProviderIds,
  wireAgentModelDiscovery,
} from "@/agent-mode/agent-model-discovery";
