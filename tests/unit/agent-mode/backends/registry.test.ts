...
} from "@/agent-mode/backends/registry";
...
jest.mock("@/agent-mode/backends/opencode/opencode-install-modal", () => ({
  OpencodeInstallModal: class {},
}));
jest.mock("@/components/modals/confirm-modal", () => ({ ConfirmModal: class {} }));
