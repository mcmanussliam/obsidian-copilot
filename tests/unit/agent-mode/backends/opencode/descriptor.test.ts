...
} from "@/agent-mode/backends/opencode/ui/opencode-version";
import {
  getOpencodeBinaryManager,
  OpencodeBackendDescriptor,
} from "@/agent-mode/backends/opencode/descriptor";
import { legacyVaultDataDir } from "@/agent-mode/backends/opencode/opencode-binary-manager";
