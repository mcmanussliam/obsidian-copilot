import { verifyOpencodeBinary } from "@/agent-mode/backends/opencode/opencode-binary-manager";
...
import type { Skill } from "@/agent-mode/skills";
import {
...
} from "@/agent-mode/backends/opencode/opencode-backend";
import {
  buildAgentSystemPrompt,
  COPILOT_PROMPT_BASE,
} from "@/agent-mode/backends/shared/agent-system-prompt";
import {
...
} from "@/builtin-skills/builtin-skills";
...
jest.mock("@/agent-mode/backends/opencode/opencode-binary-manager", () => ({
  ...jest.requireActual("@/agent-mode/backends/opencode/opencode-binary-manager"),
