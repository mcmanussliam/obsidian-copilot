import * as opencodeVersion from "@/agent-mode/backends/opencode/ui/opencode-version";
import { OpencodeBinaryManager } from "@/agent-mode/backends/opencode/opencode-binary-manager";
...
jest.mock("@/agent-mode/backends/shared/extract-archive", () => ({ extractArchive: jest.fn() }));
jest.mock("@/agent-mode/backends/opencode/platform-resolver", () => ({
