...
} from "@/agent-mode/backends/codex/codex-archive";
...
jest.mock("@/agent-mode/backends/codex/codex-archive", () => ({
  ...jest.requireActual<object>("@/agent-mode/backends/codex/codex-archive"),
...
import { CodexBinaryManager } from "@/agent-mode/backends/codex/codex-binary-manager";

jest.mock("@/utils/detect-binary", () => ({
  ...jest.requireActual("@/utils/detect-binary"),
  detectBinary: jest.fn(),
}));
jest.mock("@/logger", () => ({ logInfo: jest.fn(), logWarn: jest.fn(), logError: jest.fn() }));
jest.mock("@/utils/desktop-runtime", () => {
  const actual = jest.requireActual<object>("@/utils/desktop-runtime");
