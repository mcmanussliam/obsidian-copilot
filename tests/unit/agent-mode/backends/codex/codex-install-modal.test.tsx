...
import {
  ...
  CodexInstallModal,
} from "@/agent-mode/backends/codex/codex-install-modal";
import { CodexBackendDescriptor } from "@/agent-mode/backends/codex/descriptor";
...
jest.mock("@/agent-mode/backends/codex/descriptor", () => ({
