import { codexAuth } from "@/agent-mode/backends/codex/codex-auth";
...
import { resolveCodexAcpBinary } from "@/agent-mode/backends/codex/codex-binary-resolver";
import { CODEX_PINNED_VERSION } from "@/agent-mode/backends/codex/codex-archive";
import {
  CodexBackendDescriptor,
  detectCodexAcpPath,
  getCodexBinaryManager,
} from "@/agent-mode/backends/codex/descriptor";
import {
  isSupportedCodexAcpPath,
  inspectCodexAcpPackage,
  CODEX_MIN_VERSION,
} from "@/agent-mode/backends/codex/codex-version";

jest.mock("@/utils/detect-binary", () => ({ detectBinary: jest.fn() }));
jest.mock("@/agent-mode/backends/codex/codex-binary-resolver", () => ({
  codexAcpSearchDirs: jest.fn(),
  resolveCodexAcpBinary: jest.fn(),
}));
jest.mock("@/agent-mode/backends/codex/codex-version", () => ({
  ...jest.requireActual("@/agent-mode/backends/codex/codex-version"),
