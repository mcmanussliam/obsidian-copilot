...
import { OPENARTIFACTS_WORKSPACE_ROOT_ENV } from "@/open-artifacts/constants";
...
import { CodexBackend } from "@/agent-mode/backends/codex/codex-backend";
import { resolveSupportedCodexAcpEntry } from "@/agent-mode/backends/codex/codex-version";
import * as codexVersion from "@/agent-mode/backends/codex/codex-version";
...
jest.mock("@/agent-mode/backends/codex/codex-version", () => {
  const actual = jest.requireActual("@/agent-mode/backends/codex/codex-version");
  return {
    ...actual,
    __esModule: true,
...
jest.mock("@/agent-mode/skills", () => {
  const actual = jest.requireActual("@/agent-mode/skills");
  return {
    ...actual,
    SkillManager: {
      hasInstance: () => true,
