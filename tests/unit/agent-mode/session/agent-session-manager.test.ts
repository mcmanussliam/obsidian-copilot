...
import { AgentSession } from "@/agent-mode/session/agent-session";
import type { AgentModelPreloader } from "@/agent-mode/session/agent-model-preloader";
import { buildNativeChatId } from "@/utils/native-chat-id";
import { CHAT_AGENT_VIEWTYPE } from "@/constants";
import { playNotificationSound } from "@/utils/notification-sound";
import { AgentSessionIndex } from "@/agent-mode/session/agent-session-index";
import { AgentSessionManager } from "@/agent-mode/session/agent-session-manager";
...
import { getProjectContextSignature } from "@/projects/project-context-signature";
import { MethodUnsupportedError } from "@/agent-mode/session/errors";
import { buildCodexModeMapping } from "@/agent-mode/backends/codex/codex-mode-mapping";
import type {
  BackendDescriptor,
  BackendId,
  BackendModelCatalog,
...
jest.mock("@/instructions/agents-file", () => ({
  ...jest.requireActual("@/instructions/agents-file"),
...
jest.mock("@/projects/project-file-manager", () => ({
  ProjectFileManager: {
...
jest.mock("@/context/project-context-materializer", () => {
  const { getProjectContextSignature } = jest.requireActual("@/projects/project-context-signature");
