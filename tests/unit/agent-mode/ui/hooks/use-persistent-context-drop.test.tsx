import { usePersistentContextDrop } from "@/agent-mode/ui/hooks/use-persistent-context-drop";
import type { ProjectConfig } from "@/ai-params";
import { updateCachedProjectRecords } from "@/projects/state";
import { createPatternSettingsValue, getDecodedPatterns } from "@/search/search-utils";
