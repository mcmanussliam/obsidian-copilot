...
import type { AgentAnswer, AgentAnswerStatus } from "@/agent-mode/session/fanout/fanout-types";
...
import type { FanoutSummaryStatus } from "@/agent-mode/session/fanout/fanout-types";
import {
  agentStateForAnswer,
  agentStateForStatus,
  buildFanoutOptions,
