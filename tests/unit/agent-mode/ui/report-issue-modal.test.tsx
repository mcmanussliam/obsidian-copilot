import {
  ...
  ReportIssueModal,
  uploadReport,
} from "@/agent-mode/ui/report-issue-modal";
import type {
  PreparedReport,
  ReportSourceId,
  ReportSourceOption,
  UploadOutcome,
} from "@/agent-mode/ui/report-issue-flow";
import { logWarn } from "@/logger";
import { getSettings, setSettings } from "@/settings/model";
import type { ReportInput } from "@/utils/issue-report";
import { ReportUploadError, type ReportUploader } from "@/utils/report-upload";
...
const realIssueReport =
  jest.requireActual<typeof import("@/utils/issue-report")>("@/utils/issue-report");
...
jest.mock("@/utils/desktop-runtime", () => ({
  ...jest.requireActual("@/utils/desktop-runtime"),
...
jest.mock("@/utils/issue-report", () => ({
  ...jest.requireActual("@/utils/issue-report"),
...
jest.mock("@/agent-mode/ui/report-screenshot", () => ({
