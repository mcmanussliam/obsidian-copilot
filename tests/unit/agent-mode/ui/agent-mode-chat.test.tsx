...
import { AgentModeChat } from "@/agent-mode/ui/agent-mode-chat";
...
jest.mock("@/agent-mode/ui/agent-home", () => ({
...
jest.mock("@/agent-mode/ui/agent-mode-status", () => ({
  AgentModeStatus: () => <div data-testid="status-card" />,
}));
jest.mock("@/agent-mode/ui/agent-select-panel", () => ({
  AgentSelectPanel: () => <div data-testid="select-panel" />,
}));
jest.mock("@/agent-mode/ui/agent-chat-controls", () => ({
