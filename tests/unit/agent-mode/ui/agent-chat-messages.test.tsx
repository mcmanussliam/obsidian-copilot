...
jest.mock("@/hooks/use-chat-scrolling", () => ({
...
jest.mock("@/components/chat-components/chat-single-message", () => ({
  __esModule: true,
  default: ({
    message,
    footerStart,
