import type { AgentBrand, InstallState } from "@/agent-mode/session/types";
import { Bot } from "lucide-react";
import { AppContext } from "@/context";
import { PluginProvider } from "@/contexts/plugin-context";
import { DEFAULT_SETTINGS } from "@/constants";
import type { RejectedSkill, Skill } from "@/agent-mode/skills/types";
...
import { __resetVaultBaseCache } from "@/utils/vault-path";
import { act, fireEvent, render, screen } from "@testing-library/react";
import { FileSystemAdapter, TFile, TFolder, type App } from "obsidian";
import React from "react";
import type CopilotPlugin from "@/main";
import type { SkillLoadIssue } from "@/agent-mode/skills/ui/skill-load-issues";
import { SkillsSettings } from "@/agent-mode/skills/ui/skills-settings";
...
jest.mock("@/agent-mode/session/use-backend-install-states", () => ({
...
jest.mock("@/agent-mode/skills/skill-manager", () => ({
  SkillManager: {
    getInstance: () => ({
      refresh,
...
jest.mock("@/agent-mode/skills/ui/skill-load-issues", () => {
  const actual = jest.requireActual("@/agent-mode/skills/ui/skill-load-issues");
  return {
    ...actual,
...
jest.mock("@/utils/open-with-system-default", () => ({ openWithSystemDefault: jest.fn() }));
jest.mock("@/utils/open-vault-path", () => ({ openVaultPath: jest.fn() }));
