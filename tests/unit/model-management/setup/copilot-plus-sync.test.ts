import type { BrevilabsModelsResponse } from "@/llm-providers/brevilabs-client";
import type { ModelManagementApi } from "@/model-management/create-model-management";
import type { RegisterPlusProviderInput } from "@/model-management/setup/copilot-plus-setup-api";
import {
  plusSyncNeeded,
  syncCopilotPlusProvider,
} from "@/model-management/setup/copilot-plus-sync";
