...
import type { CatalogDownloadService } from "@/model-management/catalog/catalog-download-service";
import type { ModelManagementCoordinator } from "@/model-management/create-model-management";
import type { CatalogProvider, ModelInfo } from "@/model-management/types/catalog";
import type { BackendType, ConfiguredModel, Provider } from "@/model-management/types/persisted";
import type { BackendConfigRegistry } from "@/model-management/backends/backend-config-registry";
