import { listProviderModels } from "@/model-management/providers/adapters/list-provider-models";

jest.mock("@/model-management/providers/adapters/list-open-ai-compatible-models", () => ({
  listOpenAICompatibleModels: jest.fn(),
}));
jest.mock("@/model-management/providers/adapters/list-anthropic-models", () => ({
  listAnthropicModels: jest.fn(),
}));
jest.mock("@/model-management/providers/adapters/list-google-models", () => ({
  listGoogleModels: jest.fn(),
}));

import { listAnthropicModels } from "@/model-management/providers/adapters/list-anthropic-models";
import { listGoogleModels } from "@/model-management/providers/adapters/list-google-models";
import { listOpenAICompatibleModels } from "@/model-management/providers/adapters/list-open-ai-compatible-models";
