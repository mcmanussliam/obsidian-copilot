...
import { openaiCompatibleAdapter } from "@/model-management/providers/adapters/openai-compatible-adapter";

jest.mock("@/model-management/providers/adapters/verify-via-list-models", () => ({
  verifyViaListModels: jest.fn(),
}));

import { verifyViaListModels } from "@/model-management/providers/adapters/verify-via-list-models";

import type { Provider } from "@/model-management/types/persisted";
