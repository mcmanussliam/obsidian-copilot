...
jest.mock("@/model-management/ui/dialogs/configure-provider-dialog", () => ({
  ConfigureProviderModal: jest.fn().mockImplementation(() => ({ open: mockConfigureOpen })),
}));
jest.mock("@/model-management/ui/dialogs/add-provider-dialog", () => ({
  AddProviderModal: jest.fn().mockImplementation(() => ({ open: mockAddProviderOpen })),
}));

import { ByokPanel } from "@/model-management/ui/tabs/byok-panel";
