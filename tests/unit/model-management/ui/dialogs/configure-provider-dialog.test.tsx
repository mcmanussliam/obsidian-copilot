...
jest.mock("@/model-management/ui/model-management-context", () => ({
...
jest.mock("@/model-management/state/atoms", () => {
...
jest.mock("@/model-management/providers/adapters/list-provider-models", () => ({
  listProviderModels: (...args: unknown[]) => mockListProviderModels(...args),
}));

import type { ProviderDefinition } from "@/model-management/types/runtime";
import { CUSTOM_OPENAI_DEFINITION } from "@/model-management/catalog/builtin-definitions";
import { ConfigureProviderForm } from "@/model-management/ui/dialogs/configure-provider-dialog";
