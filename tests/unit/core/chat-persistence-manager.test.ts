...
import type { MessageRepository } from "@/core/message-repository";
import { ChatPersistenceManager } from "@/core/chat-persistence-manager";
import { mockTFile, mockTFolder } from "@tests/helpers/mock-obsidian";
import { getSettings } from "@/settings/model";
import { getEffectiveConversationsFolder } from "@/settings/copilot-folder";
