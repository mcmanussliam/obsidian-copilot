...
jest.mock("@/core/ContextCompactor");
jest.mock("@/core/ContextManager");
jest.mock("@/logger", () => ({
  logInfo: jest.fn(),
  logWarn: jest.fn(),
}));
...
jest.mock("@/core/ChatPersistenceManager", () => ({
...
import { ChatPersistenceManager } from "@/core/ChatPersistenceManager";
