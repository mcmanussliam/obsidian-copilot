import { obsidianDailyReadTool, obsidianRandomReadTool } from "@/tools/obsidian-cli-daily-tools";
import {
  runDailyReadCommand,
  runRandomReadCommand,
} from "@/services/obsidian-cli/obsidian-cli-client";
...
jest.mock("@/services/obsidian-cli/obsidian-cli-client", () => ({
