import type { AgentProjectContextLoadState, ProjectConfig } from "@/ai-params";
import * as adapter from "@/components/project/agent-processing-adapter";
import { useAgentPersistentFailureCount } from "@/components/project/use-agent-persistent-failure-count";
import {
...
jest.mock("@/context/materialize-candidates", () => ({
