...
import { CloudAgentProvider } from "@/components/chat-components/context/cloud-agent-context";
import { AgentPillContent } from "@/components/chat-components/pills/agent-pill-node";
...
jest.mock("@/components/ui/self-host-cloud-warning-icon", () => ({
