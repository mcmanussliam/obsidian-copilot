...
jest.mock("@/components/chat-components/chat-history-popover", () => ({
  ChatHistoryPopover: ({ children }: { children: React.ReactNode }) => children,
}));
jest.mock("@/components/chat-components/chat-settings-popover", () => ({
  ChatSettingsPopover: () => null,
}));
jest.mock("@/components/chat-components/token-counter", () => ({
  TokenCounter: () => null,
}));
