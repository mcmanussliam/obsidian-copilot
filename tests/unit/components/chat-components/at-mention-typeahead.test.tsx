...
import { AtMentionTypeahead } from "@/components/chat-components/at-mention-typeahead";

// Mock scrollIntoView for jsdom
Element.prototype.scrollIntoView = jest.fn();

// Mock hooks
jest.mock("@/components/chat-components/hooks/use-at-mention-categories", () => ({
...
jest.mock("@/components/chat-components/hooks/use-at-mention-search", () => ({
