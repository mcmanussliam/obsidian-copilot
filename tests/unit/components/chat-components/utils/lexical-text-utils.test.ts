import { parseTextForPills } from "@/components/chat-components/utils/lexical-text-utils";
import { App, TFile } from "obsidian";
import { mockTFolder } from "@tests/helpers/mock-obsidian";
...
jest.mock("@/components/chat-components/constants/tools", () => ({
