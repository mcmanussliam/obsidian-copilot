...
import {
  ...
  $createAgentPillNode,
  $isAgentPillNode,
} from "@/components/chat-components/pills/agent-pill-node";
...
jest.mock("@/components/ui/model-selector", () => ({ ModelSelector: () => null }));
jest.mock("@/components/chat-components/context-control", () => ({ ContextControl: () => null }));
jest.mock("@/components/chat-components/add-context-button", () => ({
  AddContextButton: () => null,
}));
jest.mock("@/components/chat-components/lexical-editor", () => ({
  __esModule: true,
