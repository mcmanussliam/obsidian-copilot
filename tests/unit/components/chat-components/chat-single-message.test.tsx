...
} from "@/components/chat-components/chat-single-message";
...
jest.mock("@/components/chat-components/inline-message-editor", () => ({
...
jest.mock("@/llm-providers/chain-runner/utils/tool-call-parser", () => ({
  parseToolCallMarkers: jest.fn((message: string) => ({
    segments: [{ type: "text", content: message }],
  })),
}));

jest.mock("@/llm-providers/chain-runner/utils/citation-utils", () => ({
