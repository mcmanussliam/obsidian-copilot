...
import { requestLatestRelease } from "@/hooks/use-latest-version";
import { ReleaseNotesModal } from "@/components/release-update/release-notes-dialog";
import { isNewerVersion } from "@/utils";
import { logWarn } from "@/logger";
import { App, Notice } from "obsidian";

jest.mock("@/hooks/use-latest-version", () => ({ requestLatestRelease: jest.fn() }));
jest.mock("@/components/release-update/release-notes-dialog", () => ({
