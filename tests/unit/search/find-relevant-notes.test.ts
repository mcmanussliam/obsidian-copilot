...
import { getBacklinkedNotes, getLinkedNotes } from "@/note-utils";
import {
  findRelevantNotes,
...
jest.mock("@/miyo/miyo-client", () => {
  const actual = jest.requireActual<typeof import("@/miyo/miyo-client")>("@/miyo/miyo-client");
  return {
