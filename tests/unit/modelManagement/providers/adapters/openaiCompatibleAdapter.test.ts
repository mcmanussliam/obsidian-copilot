...
import { openaiCompatibleAdapter } from "@/modelManagement/providers/adapters/openaiCompatibleAdapter";

jest.mock("@/modelManagement/providers/adapters/verifyViaListModels", () => ({
  verifyViaListModels: jest.fn(),
}));

import { verifyViaListModels } from "@/modelManagement/providers/adapters/verifyViaListModels";
