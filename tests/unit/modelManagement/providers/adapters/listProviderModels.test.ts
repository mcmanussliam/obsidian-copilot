...
jest.mock("@/modelManagement/providers/adapters/listOpenAICompatibleModels", () => ({
  listOpenAICompatibleModels: jest.fn(),
}));
jest.mock("@/modelManagement/providers/adapters/listAnthropicModels", () => ({
  listAnthropicModels: jest.fn(),
}));
jest.mock("@/modelManagement/providers/adapters/listGoogleModels", () => ({
  listGoogleModels: jest.fn(),
}));

import { listAnthropicModels } from "@/modelManagement/providers/adapters/listAnthropicModels";
import { listGoogleModels } from "@/modelManagement/providers/adapters/listGoogleModels";
import { listOpenAICompatibleModels } from "@/modelManagement/providers/adapters/listOpenAICompatibleModels";
