...
import { clearProjectMarkers } from "@/context/project-marker-cleanup";
import { markersDir } from "@/context/conversions-location";

jest.mock("@/context/conversions-location", () => ({ markersDir: jest.fn() }));
