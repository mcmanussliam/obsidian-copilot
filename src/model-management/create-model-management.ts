...
import { BackendConfigRegistry } from "@/model-management/backends/backend-config-registry";
import { CatalogDownloadService } from "@/model-management/catalog/catalog-download-service";
import { ChatModelFactory } from "@/model-management/chat-model/chat-model-factory";
import { ConfiguredModelRegistry } from "@/model-management/models/configured-model-registry";
import {
  createDefaultAdapterRegistry,
  ProviderAdapterRegistry,
} from "@/model-management/providers/adapters/provider-adapter-registry";
import { ProviderRegistry } from "@/model-management/providers/provider-registry";
import { AgentSetupApi } from "@/model-management/setup/agent-setup-api";
import { ByokSetupApi } from "@/model-management/setup/byok-setup-api";
import { CopilotPlusSetupApi } from "@/model-management/setup/copilot-plus-setup-api";
