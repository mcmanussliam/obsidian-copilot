 ...
 * (also in `src/model-management`) instantiates it. Plugin boot does
...
import { transformWireToCatalog } from "./catalog-transform";
import { isPlainObject } from "./models-dev-wire";
