...
import { translateBackendState } from "@/agent-mode/session/translate-backend-state";
import { parseClaudeTranscript } from "./claude-session-transcript";
import { readClaudePlanUsage } from "./claude-plan-usage";
import { withoutExpiredWindows } from "@/agent-mode/session/plan-usage";
import type {
  PlanUsage,
  AgentChatMessage,
  BackendConfigOption,
...
import type { ProjectScopeId } from "@/agent-mode/session/scope";
import { AuthRequiredError, MethodUnsupportedError } from "@/agent-mode/session/errors";
import { requireNodeModule } from "@/utils/desktop-runtime";
import { createClaudeTaskPlanState, type ClaudeTaskPlanState } from "./claude-todo-plan";
import { ClaudeBackgroundTaskStateMachine } from "./claude-task-protocol";
import {
  createTranslatorState,
  mapStopReason,
  translateSdkMessage,
} from "./sdk-message-translator";
import { PermissionBridge, type AskUserQuestionPrompter } from "./permission-bridge";
import {
  getCachedSdkCatalog,
...
import { guardSdkStreamStall } from "./sdk-stream-stall-guard";
