...
import { PERMISSION_OPTION_KINDS } from "@/agent-mode/session/types";
import { resolveToolName } from "@/agent-mode/session/tool-name";
import { isVaultWriteToolKind } from "@/agent-mode/session/fanout/fanout-types";
import { err2String } from "@/utils";
import { logSdkInbound, logSdkOutbound } from "./sdk-debug-tap";
import { deriveToolKind, deriveToolTitle, vendorMetaFields } from "./tool-meta";
