...
} from "@/utils/chat-image-persistence";
import { serializeFanoutComposite } from "@/agent-mode/session/fanout/fanout-types";
...
import { joinPosix } from "@/utils/path-utils";
import { TFile, type App } from "obsidian";
import { Notice } from "obsidian";
import { coerceProjectId, escapeYamlString, unescapeYamlString } from "./agent-chat-yaml";
