...
import { AgentMessageStore } from "@/agent-mode/session/agent-message-store";
import { GLOBAL_SCOPE, type ProjectScopeId } from "@/agent-mode/session/scope";
import {
  AgentChatMessage,
  AgentMessagePart,
  AgentPlanEntry,
...
import { deriveChatTitleFromMessages } from "@/agent-mode/session/chat-history-merge";
import { ContextProcessor } from "@/context-processor";
import type { ContextMaterializationResult } from "@/context/project-context-materializer";
import { escapeXml } from "@/llm-providers/chain-runner/utils/xml-parsing";
import type { FanoutRunInput } from "@/agent-mode/session/fanout/fanout-orchestrator";
import { isFanout } from "@/agent-mode/session/fanout/answerers";
import {
