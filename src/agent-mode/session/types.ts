...
import type { PlanUsage } from "@/agent-mode/session/plan-usage";

export type { PlanUsage, UsageWindow } from "@/agent-mode/session/plan-usage";
 ...
 * import `@/model-management` — the backend computes `credentialState`.
 */
