import type { BackendState } from "@/agent-mode/session/types";
import { resolveEffort } from "@/lib/model-effort";
import { logError, logInfo, logWarn } from "@/logger";
import type CopilotPlugin from "@/main";
import { AgentChatUIState } from "@/agent-mode/session/agent-chat-ui-state";
import {
...
} from "@/context/project-context-materializer";
import type {
  MaterializedSourceType,
  MaterializeSourceIdentity,
  SourceFailure,
} from "@/context/context-cache-store";
import { err2String } from "@/utils";
import type { ChatHistoryItem } from "@/components/chat-components/chat-history-popover";
import { fileToHistoryItem, readChatPathProjectId } from "@/utils/chat-history-utils";
import { readFrontmatterViaAdapter } from "@/utils/vault-adapter-utils";
import { App, FileSystemAdapter, Notice, Platform, TFile } from "obsidian";
import { v4 as uuidv4 } from "uuid";
import { AgentSession, ATTENTION_TRIGGER_STATUSES, DEFAULT_TITLE_PREFIX } from "./agent-session";
import type { AgentChatPersistenceManager } from "./agent-chat-persistence-manager";
import type { AgentModelPreloader } from "./agent-model-preloader";
import { buildNativeChatId, parseNativeChatId } from "@/utils/native-chat-id";
import { CHAT_AGENT_VIEWTYPE } from "@/constants";
import { playNotificationSound } from "@/utils/notification-sound";
import type { AgentSessionIndex } from "./agent-session-index";
import {
...
import { replayPersistedMode } from "./replay-persisted-mode";
import {
  FanoutOrchestrator,
  type FanoutHost,
  type FanoutRunInput,
} from "./fanout/fanout-orchestrator";
import type { FanoutTurn } from "./fanout/fanout-types";
import { modelCatalogSignature } from "./translate-backend-state";
...
} from "@/projects/project-context-signature";
import { ProjectContentTracker } from "@/context/project-content-tracker";
import { buildProjectContextUpdatesBlock } from "@/context/context-updates-block-builder";
import { ensureAgentsFileForDiscovery } from "@/instructions/agents-file";
import { moveProjectPromptToAgentsFile } from "@/projects/move-project-prompt";
import { getProjectAnchorFromConfigPath } from "@/projects/project-paths";
