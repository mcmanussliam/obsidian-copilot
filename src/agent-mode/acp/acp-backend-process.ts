...
import { AcpProcessManager, AcpProcessManagerOptions } from "./acp-process-manager";
import { VaultClient } from "./vault-client";
import { JSONRPC_METHOD_NOT_FOUND, MethodUnsupportedError } from "@/agent-mode/session/errors";
import type {
  BackendDescriptor,
  BackendProcess,
  BackendState,
...
import { wrapStreamsForDebug } from "./debug-tap";
import { AcpBackend } from "./types";
import {
  withoutExpiredWindows,
  type PlanUsage,
  type PlanUsageReading,
} from "@/agent-mode/session/plan-usage";
import {
  consumeReplayUpdate,
