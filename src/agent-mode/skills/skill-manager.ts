import type { BuiltinPreferences } from "./builtin/reconcile-builtin-skills";
import { ALL_MANAGED_SKILLS, planManagedBuiltins } from "@/builtin-skills/builtin-skills";
import { logError, logInfo, logWarn } from "@/logger";
import { getSettings, updateSetting } from "@/settings/model";
import { getEffectiveSkillsFolder } from "@/settings/copilot-folder";
import { publishSkillLoadErrorCount } from "@/settings/skill-load-error-state";
import { atom, createStore, useAtomValue } from "jotai";
import { FileSystemAdapter, type App, type EventRef, type TAbstractFile } from "obsidian";
import { normalizeAbsPath, parentDir } from "@/utils/path-utils";
import { agentSkillsDirAbs, DEFAULT_SKILLS_FOLDER } from "./agent-paths";
import { discoverManagedSkills, type SkillsFsAdapter } from "./discover-managed-skills";
import { discoverProjectSkills, type ProjectSkillCandidate } from "./discover-project-skills";
import { compareSkills, mergeDiscovery } from "./merge-discovery";
import {
  duplicateSourceDirsFor,
  migrateProjectSkill,
  type MigrateSkillResult,
} from "./migrate-project-skill";
import { suffixOnCollision } from "./suffix-on-collision";
import {
  createNodeMigrateSkillFs,
  createNodeProjectDiscoveryFs,
  createNodeReconcileFs,
} from "./node-fs-adapters";
import { reconcile, type ReconcileReport } from "./reconcile";
import type { SkillFrontmatterPatch } from "./skill-format";
import { removeAgentLinksPointingTo } from "./symlinks";
import { runDeleteSkill, runToggleAgent } from "./toggle-agent";
import type { BackendId, RejectedSkill, Skill } from "./types";
import { runRenameSkill, runUpdateProperties } from "./update-properties";
import {
