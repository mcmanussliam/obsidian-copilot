...
import { joinPosix, parentDir } from "@/utils/path-utils";
import { getBuiltinSkillVersion } from "./builtin-ownership";
import { BUILTIN_SKILLS, type BuiltinSkill } from "@/builtin-skills/builtin-skills";
...
/**
 * Remove a Copilot-managed skill directory, including any user-added files.
 * Missing or unmarked SKILL.md files do not establish ownership and are left alone.
