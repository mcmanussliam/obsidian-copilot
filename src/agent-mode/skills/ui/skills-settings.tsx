import { availableBuiltinAgents } from "@/agent-mode/skills/builtin/reconcile-builtin-skills";
import { useBackendInstallStates } from "@/agent-mode/session/use-backend-install-states";
import { ALL_MANAGED_SKILLS, planManagedBuiltins } from "@/builtin-skills/builtin-skills";
import { parseSkillFile } from "@/agent-mode/skills/skill-format";
import { BuiltinSkillsTable } from "./builtin-skills-table";
import { formatSkillDisplayName } from "@/agent-mode/skills/merge-discovery";
import {
  buildSkillRepairPrompt,
  type SkillRepairEvidence,
} from "@/agent-mode/skills/skill-repair-prompt";
import { listBackendDescriptors } from "@/agent-mode/backends/registry";
import type { AgentBrand } from "@/agent-mode/session/types";
import { DeleteConfirmModal } from "./delete-confirm-dialog";
...
import { type Skill } from "@/agent-mode/skills/types";
import { Input } from "@/components/ui/input";
import { cn } from "@/lib/utils";
import { deriveSkillsFolder } from "@/settings/copilot-folder";
import { openWithSystemDefault } from "@/utils/open-with-system-default";
import { openVaultPath } from "@/utils/open-vault-path";
import { revealFolderInExplorer } from "@/utils/reveal-folder-in-explorer";
import { getVaultBase, toVaultRelative } from "@/utils/vault-path";
