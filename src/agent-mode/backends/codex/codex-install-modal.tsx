import { useBackendAuthState } from "@/agent-mode/session/use-backend-auth-state";
import type { CodexBinaryManager } from "@/agent-mode/backends/codex/codex-binary-manager";
import { CODEX_PINNED_VERSION, codexSignInCommand } from "@/agent-mode/backends/codex/cli-setup";
import {
  CodexConfigView,
  type CodexBinarySource,
} from "@/agent-mode/backends/codex/ui/codex-config-view";
import { ManagedInstallOperationInFlightError } from "@/agent-mode/backends/shared/managed-install";
import { ConfirmModal } from "@/components/modals/confirm-modal";
import { FullBleedReactModal } from "@/components/modals/react-modal";
import { useApp } from "@/context";
import { logError } from "@/logger";
import { useSettingsValue } from "@/settings/model";
import { formatBinaryPathForDisplay } from "@/utils/binary-path";
