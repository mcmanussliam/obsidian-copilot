import type { BackendAuth, BackendAuthStatus } from "@/agent-mode/session/types";
import { buildSimpleSpawnDescriptor } from "@/agent-mode/backends/shared/simple-binary-backend";
import { sanitizeBuiltinSkillEnvOverrides } from "@/agent-mode/backends/shared/builtin-skill-env";
import { signInWithCli, signOutWithCli } from "@/agent-mode/backends/shared/cli-sign-in";
import { requireNodeModule } from "@/utils/desktop-runtime";
import { detectBinary } from "@/utils/detect-binary";
import { buildCodexAcpInvocation, resolveSupportedCodexAcpEntry } from "./codex-version";
