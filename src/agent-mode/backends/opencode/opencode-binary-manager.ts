...
} from "@/agent-mode/backends/shared/binary-compatibility";
import { extractArchive } from "@/agent-mode/backends/shared/extract-archive";
import {
  ManagedBinaryManager,
  type BinarySettings,
  type InstalledBinary,
} from "@/agent-mode/backends/shared/managed-binary-manager";
import { OPENCODE_MIN_VERSION, OPENCODE_PINNED_VERSION } from "./ui/opencode-version";
...
import { copilotAppDataDir } from "@/utils/app-paths";
import { requireNodeModule } from "@/utils/desktop-runtime";
import { expectedBinaryName, resolveOpencodeTarget } from "./platform-resolver";
import type { InstallState as BackendInstallState } from "@/agent-mode/session/types";
import {
  ManagedInstallAbortError,
  ManagedInstallOperationInFlightError,
  promoteManagedVersion,
  type ManagedInstallRuntimeState,
} from "@/agent-mode/backends/shared/managed-install";
