...
} from "@/agent-mode/backends/opencode/ui/opencode-config-view";
import {
  AbortError,
  computeInstallState,
  ...
  type ProgressEvent,
} from "@/agent-mode/backends/opencode/opencode-binary-manager";
import type { OpencodeBinaryManager } from "@/agent-mode/backends/opencode/opencode-binary-manager";
import { detectOpencodeCliPath } from "@/agent-mode/backends/opencode/descriptor";
...
import { OPENCODE_PINNED_VERSION } from "@/agent-mode/backends/opencode/ui/opencode-version";
