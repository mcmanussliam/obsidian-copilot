...
import { OPENCODE_PINNED_VERSION, OPENCODE_MIN_VERSION } from "./ui/opencode-version";
import { resolveEffort } from "@/lib/model-effort";
import { OpencodeInstallModal } from "@/agent-mode/backends/opencode/opencode-install-modal";
import OpencodeLogo from "@/agent-mode/backends/opencode/logo.svg";
...
} from "./opencode-binary-manager";
import { opencodeEnabledModelEntries, opencodeWireBaseIdFor } from "./opencode-model-resolve";
import { OpencodeSettingsPanel } from "./opencode-settings-panel";
import { mapNodeArch, mapNodePlatform } from "./platform-resolver";
import { cacheRoot } from "@/context/conversions-location";
import type { ModelSelectionSession } from "@/agent-mode/session/types";
import { simpleBinaryBackendProcess } from "@/agent-mode/backends/shared/simple-binary-backend";
import type {
  EffortOption,
  EnabledModelEntry,
  ModeMapping,
  ...
  ModelWireCodec,
  SessionId,
} from "@/agent-mode/session/types";
import type { BackendDescriptor, BackendProcess, InstallState } from "@/agent-mode/session/types";
import { EFFORT_LEVELS_ASCENDING } from "@/agent-mode/session/types";
import { findModelEntry } from "@/agent-mode/session/translate-backend-state";
import { phaseLabel } from "./install-progress";
import type { ManagedInstallActionState } from "@/agent-mode/session/types";
 ...
 */
export { detectOpencodeCliPath } from "./opencode-cli-detector";
