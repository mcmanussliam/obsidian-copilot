import { parseVersionFromStdout, verifyOpencodeBinary } from "./opencode-binary-manager";
import { assertBinaryCompatible } from "@/agent-mode/backends/shared/binary-compatibility";
import { OPENCODE_MIN_VERSION } from "./ui/opencode-version";
import { ChatModelProviders } from "@/constants";
import { logInfo, logWarn } from "@/logger";
import { getSettings } from "@/settings/model";
import type { CopilotSettings } from "@/settings/model";
import { providerNeedsResolvedApiKey } from "@/model-management";
import { isCatalogProviderDefaultEndpoint } from "@/utils/provider-base-url";
import type { BackendConfigRegistry, ProviderRegistry } from "@/model-management";
...
import type { CopilotMode } from "@/agent-mode/session/types";
import { composeDenyList, getManagedSkills, SkillManager } from "@/agent-mode/skills";
...
import { copilotPlusModelId, mapProviderToOpencodeId } from "./opencode-model-resolve";
import type { PlanUsageReading } from "@/agent-mode/session/plan-usage";
import { CopilotPlusUsageReader } from "@/agent-mode/backends/shared/copilot-plus-usage";
import type { SelfHostWebSearchAgentChannel } from "@/llm-providers/self-host-services";
