 ...
 *   - `AGENT_LOOP_GUIDANCE` (`src/llm-providers/chain-runner/
...
import { buildPillSyntaxDirective } from "@/agent-mode/skills/pill-syntax-directive";
import { getSettings } from "@/settings/model";
import { AGENT_TODO_PLANNING_STEERING } from "@/system-prompts/agent-todo-planning-steering";
 ...
 * capabilities (see `src/builtin-skills/builtin-skills.ts`) instead of its own
