...
import type { AgentSession } from "@/agent-mode/session/agent-session";
import { MethodUnsupportedError } from "@/agent-mode/session/errors";
import { claudeBinarySearchDirs, resolveClaudeBinary } from "./claude-binary-resolver";
import { CLAUDE_INSTALL_COMMAND } from "./cli-setup";
import { getClaudeAuthStatus, signInToClaude, signOutFromClaude } from "./claude-auth";
import { assertClaudeVersionSupported } from "./claude-version";
import { agentOriginEnabledModelEntries } from "@/agent-mode/backends/shared/agent-enabled-models";
import { ClaudeSdkBackendProcess } from "@/agent-mode/sdk/claude-sdk-backend-process";
import { getCachedSdkCatalog, synthesizeEffortConfigOption } from "@/agent-mode/sdk/effort-option";
...
import { getMiyoFolderName } from "@/miyo/miyo-utils";
import type {
  BackendAuth,
  BackendConfigOption,
  BackendDescriptor,
...
import { ClaudeInstallModal } from "./claude-install-modal";
...
} from "./claude-compatibility-store";
