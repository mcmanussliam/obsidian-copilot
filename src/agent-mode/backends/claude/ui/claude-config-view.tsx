import { CLAUDE_INSTALL_COMMAND } from "@/agent-mode/backends/claude/cli-setup";
import { claudeUpdateDetail } from "@/agent-mode/backends/claude/claude-update-detail";
import { BinaryPathSetting } from "@/agent-mode/backends/shared/binary-path-setting";
import {
  ConfigDialogShell,
  ConfigSection,
  ConfigWarningStrip,
} from "@/agent-mode/backends/shared/ui/config-dialog-shell";
import { CommandBlock } from "@/agent-mode/backends/shared/ui/setup-steps";
