import { claudeSignInCommand } from "@/agent-mode/backends/claude/cli-setup";
import { ClaudeConfigView } from "@/agent-mode/backends/claude/ui/claude-config-view";
...
import { validateExecutableFile } from "@/utils/detect-binary";
