import { backendRegistry } from "@/agent-mode/backends/registry";
import { AgentHomePreviewList } from "@/agent-mode/ui/agent-home-section";
import { RecentChatProjectBadge, RecentChatTitle } from "@/agent-mode/ui/recent-chat-title";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { SearchBar } from "@/components/ui/search-bar";
import { type ChatHistoryItem } from "@/components/chat-components/chat-history-popover";
import { ChatIconWithAttention } from "@/components/chat-components/chat-icon-with-attention";
import { logError } from "@/logger";
import { cn } from "@/lib/utils";
import { isNativeChatId } from "@/utils/native-chat-id";
import { formatCompactRelativeTime } from "@/utils/format-relative-time";
import { sortByStrategy, type SortStrategy } from "@/utils/recent-usage-manager";
import { ArrowUpRight, Check, Edit2, LoaderCircle, MessageCircle, Trash2, X } from "lucide-react";
import React, { memo, useCallback, useEffect, useMemo, useState } from "react";
import { useIncrementalPaging } from "@/hooks/use-incremental-paging";
