...
import { expandCustomCommandPrefix } from "@/agent-mode/session/expand-custom-command-prefix";
import { resolveActiveNoteToken } from "@/agent-mode/session/resolve-active-note-token";
import type { PromptContent } from "@/agent-mode/session/types";
import type {
  AgentInputDraftControls,
  QueuedAgentMessage,
} from "@/agent-mode/ui/hooks/use-agent-input-drafts";
import {
...
import ChatInput, {
  ...
  type ChatInputProps,
} from "@/components/chat-components/chat-input";
import { EMPTY_AGENT_MENTION_BRANDS } from "@/components/chat-components/hooks/use-at-mention-categories";
...
import { useCanUseMultiAgent } from "@/plus-utils";
...
} from "@/agent-mode/ui/mentioned-agents";
import type { BackendId } from "@/agent-mode/session/types";
import type CopilotPlugin from "@/main";
import { getCloudAgentIds } from "@/agent-mode/backends/registry";
import { buildWebTabsWithActiveSnapshot } from "@/services/web-viewer-service/active-web-tab-snapshot";
import {
...
import { mergeWebTabContexts } from "@/utils/url-normalization";
import { QueuedMessageList } from "@/agent-mode/ui/queued-message-list";
