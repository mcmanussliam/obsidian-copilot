...
import { agentResponseText, buildAgentTrail } from "@/agent-mode/ui/agent-trail";
import type { AgentMessagePart, StopReason } from "@/agent-mode/session/types";
import { ActionCard } from "@/agent-mode/ui/action-card";
import { ActivityGroupCard } from "@/agent-mode/ui/activity-group-card";
import {
  foldActivityGroups,
  type ActivityGroupNode,
  type GroupedTrailNode,
} from "@/agent-mode/ui/activity-groups";
import { activityLiveStep, isReasoningActive } from "@/agent-mode/ui/activity-live-step";
import { AgentMessageActions } from "@/agent-mode/ui/agent-message-actions";
import { SubAgentCard } from "@/agent-mode/ui/sub-agent-card";
import { ReasoningBlock } from "@/agent-mode/ui/reasoning-block";
import { AgentMarkdownText } from "@/agent-mode/ui/agent-markdown-text";
import { planEntryClass, planEntryIcon } from "@/agent-mode/ui/plan-entry-styles";
import type { ToolSummaryContext } from "@/agent-mode/ui/tool-summaries";
import { useThinkingClock } from "@/agent-mode/ui/use-thinking-clock";
import { useTrailExpansion, type TrailExpansion } from "@/agent-mode/ui/use-trail-expansion";
import { AgentTurnDurationIndicator } from "@/agent-mode/ui/agent-turn-duration-indicator";
import { AssistantResponseFooter } from "@/components/ui/assistant-response-footer";
import { getVaultBase } from "@/utils/vault-path";
