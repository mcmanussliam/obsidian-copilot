...
import { deriveSkillsFolder } from "@/settings/copilot-folder";
import { subscribeToSystemPromptChange } from "@/system-prompts/state";
import { copilotAppDataDir, getVaultId } from "@/utils/app-paths";
import { requireNodeModule } from "@/utils/desktop-runtime";
import { buildAgentSystemPrompt } from "./backends/shared/agent-system-prompt";
import { getBuiltinSkillEnvRestartPolicy } from "./backends/shared/builtin-skill-env";
import { backendRegistry, listBackendDescriptors } from "./backends/registry";
import type { BackendId } from "./session/types";
import { AgentChatPersistenceManager } from "./session/agent-chat-persistence-manager";
import { AgentModelPreloader } from "./session/agent-model-preloader";
import { AgentSessionIndex } from "./session/agent-session-index";
import { createNodeFileStorage } from "./session/node-file-storage";
import { AgentSessionManager } from "./session/agent-session-manager";
import { seedCopilotDefaultModel } from "./session/copilot-default-model";
import { SkillManager } from "./skills";
import {
  availableBuiltinAgents,
  reconcileBuiltinSkills,
} from "./skills/builtin/reconcile-builtin-skills";
import {
  saveBuiltinPreferences,
  type BuiltinPreferencesUpdate,
} from "@/settings/builtin-skill-preferences";
import { buildBuiltinSeedFs } from "./skills/builtin/miyo-search-seed";
import {
...
export { AgentDefaultModelSetting } from "./ui/agent-default-model-setting";
export { ModelEnableList } from "@/components/ui/model-enable-list";
export type { ModelEnableGroup, ModelEnableRow } from "@/components/ui/model-enable-list";
export { PlanPreviewView, PLAN_PREVIEW_VIEW_TYPE } from "./ui/plan-preview-view";
export type { PlanPreviewViewState } from "./ui/plan-preview-view";
export { ReportIssueModal } from "./ui/report-issue-modal";
export type { ReportIssueModalParams } from "./ui/report-issue-modal";
export {
  backendDisplayOrder,
...
export { AgentBackendHeader } from "./backends/shared/ui/agent-backend-header";

export { useBackendAuthState } from "./session/use-backend-auth-state";
