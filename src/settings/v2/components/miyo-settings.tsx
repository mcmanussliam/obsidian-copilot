...
import { MiyoClient } from "@/miyo/miyo-client";
import { MiyoServiceDiscovery } from "@/miyo/miyo-service-discovery";
import { type CapabilityStatus, refreshMiyoStatus } from "@/miyo/miyo-status-store";
import {
  getMiyoCustomUrl,
  getMiyoFolderName,
  isLocalMiyoUrl,
...
import { MiyoConnectionPanel } from "@/settings/v2/components/ui/miyo-connection-panel";
import { useMiyoStatus } from "@/miyo/use-miyo-status";
import { notifyMiyoIndexChanged } from "@/miyo/miyo-index";
import { extractAppIgnoreSettings, getSystemExcludedFolders } from "@/search/search-utils";
import { getSettings, setSettings, updateSetting, useSettingsValue } from "@/settings/model";
import {
  type ConnectOutcome,
  type ConnectStep,
  MiyoConnectModal,
} from "@/settings/v2/components/miyo-connect-modal";
import { MiyoStatusRow } from "@/settings/v2/components/miyo-status-row";
import {
  MiyoAvailabilityNotice,
  MiyoConnectionControl,
} from "@/settings/v2/components/ui/miyo-connection-control";
