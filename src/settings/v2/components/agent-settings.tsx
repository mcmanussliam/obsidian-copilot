...
import { QuickChatPanel } from "./quick-chat-panel";
import { ConfiguredModelEnableList } from "./configured-model-enable-list";
import { AgentNotificationSoundSettings } from "./ui/agent-notification-sound-settings";
 ...
 * this, because the `@/agent-mode` barrel it imports pulls in Node-only modules.
 */
