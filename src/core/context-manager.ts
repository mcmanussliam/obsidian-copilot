import { getSelectedTextContexts } from "@/ai-params";
import { ChainType } from "@/chain-type";
import { processPrompt } from "@/commands/custom-command-utils";
import { LOADING_MESSAGES } from "@/constants";
import { PromptContextEngine } from "@/context/prompt-context-engine";
import { compactXmlBlock, getL2RefetchInstruction } from "@/context/l2-context-compactor";
import { CONTEXT_BLOCK_TYPES } from "@/context/context-block-registry";
import { parseContextIntoSegments } from "@/context/parse-context-segments";
import {
  PromptContextEnvelope,
  PromptLayerId,
  PromptLayerSegment,
} from "@/context/prompt-context-types";
...
let ContextCompactorClass: typeof import("./context-compactor").ContextCompactor | null = null;
async function getContextCompactor() {
  if (!ContextCompactorClass) {
    const module = await import("./context-compactor");
