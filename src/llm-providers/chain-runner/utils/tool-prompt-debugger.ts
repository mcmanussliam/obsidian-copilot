import { PromptSection, joinPromptSections } from "./model-adapter";
import { processRawChatHistory, processedMessagesToTextOnly } from "./chat-history-utils";
...
function buildPromptDebugSections(options: BuildPromptDebugSectionsOptions): PromptSection[] {
  ...
  sections.push({
    ...
    source: `src/llm-providers/chain-runner/utils/model-adapter.ts#${adapterName}.enhanceUserMessage`,
