import { getStandaloneQuestion } from "@/chain-utils";
import { TEXT_WEIGHT } from "@/constants";
import { BrevilabsClient } from "@/llm-providers/brevilabs-client";
import { hasSelfHostSearchKey, selfHostWebSearch } from "@/llm-providers/self-host-services";
import { logError, logInfo } from "@/logger";
import { isSelfHostModeValid } from "@/plus-utils";
import { RetrieverFactory } from "@/search/retriever-factory";
import { getSettings } from "@/settings/model";
import { App } from "obsidian";
import * as z from "zod";
import { deduplicateSources } from "@/llm-providers/chain-runner/utils/tool-execution";
import { createLangChainTool } from "./create-lang-chain-tool";
import { getWebSearchCitationInstructions } from "@/llm-providers/chain-runner/utils/citation-utils";
import { TieredLexicalRetriever } from "@/search/v3/tiered-lexical-retriever";
import { FilterRetriever } from "@/search/v3/filter-retriever";
import { RETURN_ALL_LIMIT } from "@/search/v3/search-core";
import { mergeFilterAndSearchResults } from "@/search/v3/merge-results";
