import { useModelKey } from "@/ai-params";
import { processCommandPrompt } from "@/commands/custom-command-utils";
...
import { SelectionHighlight } from "@/editor/selection-highlight";
import { createHighlightReplaceGuard, type ReplaceGuard } from "@/editor/replace-guard";
...
import { useResolvedChatBackendModel } from "@/hooks/use-resolved-chat-backend-model";
import { computeVerticalPlacement } from "@/utils/panel-placement";
import { computeSelectionAnchors } from "@/utils/selection-anchors";
