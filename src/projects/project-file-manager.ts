...
import { removeGeneratedInstructionFiles } from "@/instructions/agents-file";
...
import { ensureProjectsMigratedIfNeeded } from "@/projects/project-migration";
...
export class ProjectFileManager {
  ...
  public async deleteProject(projectId: string): Promise<void> {
    ...
    try {
      ...
      if (isDesktopRuntime()) {
        const { clearProjectMarkers } = await import("@/context/project-marker-cleanup");
