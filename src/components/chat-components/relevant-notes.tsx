import { useChatRelevantNotes } from "@/hooks/use-chat-relevant-notes";
import { RelevantNoteRow } from "@/components/chat-components/ui/relevant-note-row";
import { RelevantNotesPane } from "@/components/chat-components/ui/relevant-notes-pane";
import { RelevantNotesToolbar } from "@/components/chat-components/ui/relevant-notes-toolbar";
import { useRelevantNoteRowTransitions } from "@/components/chat-components/ui/use-relevant-note-row-transitions";
import { createProductUrl, PRODUCT_URLS } from "@/lib/product-links";
import { useApp } from "@/context";
import { useActiveFile } from "@/hooks/use-active-file";
import { useLiveRelevantNotesRefresh } from "@/hooks/use-live-relevant-notes-refresh";
...
import {
  ...
  MIYO_DEEPLINK_URL,
  shouldUseMiyo,
} from "@/miyo/miyo-utils";
import { getMiyoConnectionMode } from "@/miyo/miyo-runtime-policy";
import { useMiyoStatus } from "@/miyo/use-miyo-status";
import {
  findRelevantNotes,
  isSameRelevantNotesResult,
  type RelevantNoteEntry,
} from "@/search/find-relevant-notes";
import { onMiyoIndexChanged } from "@/miyo/miyo-index";
import { openCopilotSettings } from "@/settings/open-settings";
