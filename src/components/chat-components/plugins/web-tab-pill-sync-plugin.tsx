...
import {
  $isWebTabPillNode,
  WebTabPillNode,
} from "@/components/chat-components/pills/web-tab-pill-node";
import { $isActiveWebTabPillNode } from "@/components/chat-components/pills/active-web-tab-pill-node";
import { GenericPillSyncPlugin, PillSyncConfig } from "./generic-pill-sync-plugin";
