import { useChainType } from "@/ai-params";
import { ChainType } from "@/chain-type";
import { ChatModeSelector } from "@/components/chat-components/chat-mode-selector";
import { Button } from "@/components/ui/button";
import { DropdownMenuContent, DropdownMenuItem } from "@/components/ui/dropdown-menu";
import { SettingSwitch } from "@/components/ui/setting-switch";
import { Tooltip, TooltipContent, TooltipTrigger } from "@/components/ui/tooltip";
import { navigateToPlusPage, useIsPaidUser } from "@/plus-utils";
...
import {
  ChatHistoryItem,
  ChatHistoryPopover,
} from "@/components/chat-components/chat-history-popover";
import { TokenCounter } from "./token-counter";
import { ChatSettingsPopover } from "@/components/chat-components/chat-settings-popover";
