...
import { ChatButtons } from "@/components/chat-components/chat-buttons";
import { AssistantResponseFooter } from "@/components/ui/assistant-response-footer";
import { SourcesModal } from "@/components/modals/sources-modal";
...
import {
  ...
  ContextUrlBadge,
  ContextWebTabBadge,
} from "@/components/chat-components/context-badges";
import { InlineMessageEditor } from "@/components/chat-components/inline-message-editor";
import {
...
} from "@/components/chat-components/tool-call-root-manager";
import { AgentReasoningBlock } from "@/components/chat-components/agent-reasoning-block";
import { ClampedContent } from "@/components/ui/clamped-content";
import { USER_SENDER } from "@/constants";
import { cn } from "@/lib/utils";
import { parseToolCallMarkers } from "@/llm-providers/chain-runner/utils/tool-call-parser";
import { parseReasoningBlock } from "@/llm-providers/chain-runner/utils/agent-reasoning-state";
import { processInlineCitations } from "@/llm-providers/chain-runner/utils/citation-utils";
import { logError } from "@/logger";
import { ChatMessage } from "@/types/message";
import { extractYoutubeVideoId, insertAtCursor } from "@/utils";
import { preprocessAIResponse } from "@/utils/markdown-preprocess";
...
} from "@/components/chat-components/collapsible-state-utils";
