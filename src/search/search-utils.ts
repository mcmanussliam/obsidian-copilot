...
import { AGENTS_FILE_NAME, CLAUDE_FILE_NAME } from "@/instructions/agents-file";
...
import { getEffectiveProjectsFolder } from "@/settings/copilot-folder";
...
import { hasCaseInsensitiveFilesystem } from "@/utils/vault-adapter-utils";
