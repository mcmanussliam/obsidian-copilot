import { CachePreviewModal } from "@/components/modals/cache-preview-modal";
...
import { isMissingFileError } from "@/utils/is-missing-file-error";
...
export async function openAgentCachedItemPreview(
  ...
  try {
    const { remotesDir, filesDir } = await import("@/context/conversions-location");
