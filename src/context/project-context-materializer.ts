...
import { err2String } from "@/error-format";
...
import { getMatchingPatterns, shouldIndexFile, type PatternCategory } from "@/search/search-utils";
import { listMaterializeCandidates } from "@/context/materialize-candidates";
import { Mutex } from "async-mutex";
import { App, FileSystemAdapter, TFile, TFolder } from "obsidian";
import { createNodeContextCacheFs } from "./context-cache-fs";
import {
  cacheRoot,
  filesDir,
  markersDir,
...
import { buildProjectContextBlock, type ManifestPathEntry } from "./manifest-builder";
