...
export type { ContextSourceType } from "./context-block-registry";
export type { CompactionConfig as L2CompactorConfig } from "./compaction-utils";
export { compactBySection, truncateWithEllipsis } from "./compaction-utils";
export { getSourceType as detectSourceType } from "./context-block-registry";

// Re-export chat history compaction for backwards compatibility
export { compactChatHistoryContent } from "./chat-history-compactor";
